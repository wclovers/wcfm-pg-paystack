...
class WCFMpgps_Dependencies {
	...
	// Paystack WooCommerce Payment Gateway plugin
	static function woo_paystack_plugin_active_check() {
		if ( ! self::$active_plugins ) self::init();
		return in_array( 'woo-paystack/woo-paystack.php', self::$active_plugins ) || array_key_exists( 'woo-paystack/woo-paystack.php', self::$active_plugins );
		return false;
	}
}